...
//        }
        ...
        new BantchTransferThread(qtumService, 0).run();
    }
    ...
    public Integer getBlockTxs(Integer blockCount) throws Exception{
        ...
        System.out.println(Hex.toHexString("wangkai".getBytes()));
        System.out.println(new String(toBytes("77616e676b6169"), "utf-8"));
